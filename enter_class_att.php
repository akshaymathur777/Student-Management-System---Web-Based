			...
			<div class="container-fluid">
				<div class="col-md-10">
					...
					<ul class="nav navbar-nav">
						...
						<li  class="active"><a href="class_att.php">Class Attendance</a></li>
					</ul>
				</div>
			   		...
			   		<?php	
						...
						while($row1 =$result->fetch_assoc()) 
						{
							...
							if(strcmp($_SESSION['course_selected'],$s1)==0)
							{
								...
								print    			"<td>$tot1</td>";
								print    			"<td>$per1</td>";
								print               "<form name=\"enter_class_att\" method=\"POST\" action=\"insert_class_att.php\">";
								print 				"<td>  
														<div class=\"radio\">
															<label><input type=\"radio\" name=\"att\" checked=\"checked\" value=\"P\">Present</label>
														</div>
														<div class=\"radio\">
															<label><input type=\"radio\" name=\"att\" value=\"A\">Absent</label>
														</div>
